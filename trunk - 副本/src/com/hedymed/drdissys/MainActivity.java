...
public class MainActivity extends FragmentActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(savedInstanceState != null) {
			mMainFra = (mainFragment) getSupportFragmentManager().findFragmentByTag("mainFragment");
			mSecondFra = (secondFrament) getSupportFragmentManager().findFragmentByTag("secondFragment");
...
//	}
	...
	private void initFragmentViewPager() {
		...
		mViewPager.setAdapter(new MyFragmentPagerAdapter(this, getSupportFragmentManager(), mViewPager));
	}
