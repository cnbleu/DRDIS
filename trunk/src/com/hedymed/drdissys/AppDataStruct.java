...
public class AppDataStruct {
	static enum expose_status{
		DISABLE_EXPOSE, ENABLE_EXPOSE, PREP_PHASE, EXPOSE_PHASE;//禁止曝光, 使能曝光, 一档状态， 二档状态
	}
	
	static enum alignment_status{
		NOT_ALIGNMENT, HAVE_ALIGNMENT;//未对中，已对中
	}
	
	public static final byte INSERT_RIGHT = 0x01;// FPD 插入到卡位
	public static final byte INSERT_ERROR = 0x00;// FPD 未插入到卡位
	public static final byte FPD_WS_H_INSERT = 0x00;// FPD 胸片架横插
	public static final byte FPD_WS_V_INSERT = 0x01;// FPD 胸片架竖插
	public static final byte FPD_FT_H_INSERT = 0x02;// FPD 固定床横插
	public static final byte FPD_FT_V_INSERT = 0x03;// FPD 固定床竖插
	public static final byte GRID_MATERIAL_AL = 0x01;// 滤线栅材质 铝
	public static final byte GRID_MATERIAL_CARBON = 0x02;// 滤线栅材质 碳
	public static final byte FOCUS_SMALL = 0x01;// 小焦点
	public static final byte FOCUS_BIG = 0x00;// 大焦点
	public static final byte FIELD_TRACE_OFF = 0x00;// 射野追踪关
	public static final byte FIELD_TRACE_ON = 0x01;// 射野追踪开
	public static final byte ALIGN_TOP = 0x00;// 上对齐
	public static final byte ALIGN_MID = 0x01;// 中对齐
	public static final byte ALIGN_BOT = 0x02;// 下对齐
