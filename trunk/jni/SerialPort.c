...
#include "com_hedymed_uart_SerialPortJNI.h"
...
JNIEXPORT jobject JNICALL Java_com_hedymed_uart_SerialPortJNI_open485Dev
  (JNIEnv *env, jobject thiz, jint devnum){
	return Java_com_hedymed_uart_SerialPortJNI_openDev(env,  thiz,  devnum);
}
...
JNIEXPORT jint JNICALL Java_com_hedymed_uart_SerialPortJNI_close485Dev(
		JNIEnv *env, jobject thiz, jobject mfd){
	return Java_com_hedymed_uart_SerialPortJNI_closeDev(env ,thiz, mfd);
}
